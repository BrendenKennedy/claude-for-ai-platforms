...
stamp), or GitHub's **"Use this template"** (the repo *is* a copy of claude-for-ai-platform — no stamp, and it
...
- Replace `README.md` (the scaffold's own) with a minimal project stub: project title, quick start,
  and a "configured by claude-for-ai-platform vX" line. Keep `CHANGELOG.md` only if the user wants one.
