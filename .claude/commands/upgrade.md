---
description: >
  Upgrade this project's installed scaffold to a newer claude-for-ai-platform release — read the
...
- Upstream source: `$1` if given (a local clone — `git -C <path> pull` it), else clone fresh
  into the scratchpad (`git clone https://github.com/BrendenKennedy/claude-for-ai-platform`).
